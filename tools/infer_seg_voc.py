...
parser.add_argument("--model_path", default="/data/PROJECTS/Diffusion_CLIP/DiT_base_diffusion/w_outputs/voc/2025-02/voc_kv_cache_as_cam_14-16-53-47/checkpoints/model_iter_30000.pth", type=str, help="model_path")
...
def _validate(model=None, data_loader=None, args=None):
    ...
    with torch.no_grad(), torch.cuda.device(0):
        ...
        for idx, data in tqdm(enumerate(data_loader), total=len(data_loader), ncols=100, ascii=" >="):
            ...
            segs = model(inputs_cat,eval_seg=True)
