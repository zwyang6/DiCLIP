...
if __name__ == "__main__":
    ...
    segs_path = '/data/PROJECTS/Diffusion_CLIP/DiT_base_diffusion/00_exp/00_coco_sota_47.0/codes/coco_train_coco_5_cluster_18-11-51-21/val/val_model_iter_90000_segs/seg_preds'
