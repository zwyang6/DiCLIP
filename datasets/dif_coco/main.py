...
# 定义所有需要用到的路径
IMAGE_ROOT = "/home/songpf/workspace/DiffSegmenter/output_generated_resample"
DATASET_ROOT = "/home/songpf/workspace/DiffSegmenter/dif_dataset_for_coco_2"
...
def create_label_dict(image_files, num_classes=80, images_per_class=50):
    """创建标签字典"""
